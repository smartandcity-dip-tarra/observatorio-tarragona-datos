# municipios-picker-metropolitan-filter

## Purpose

Municipios picker modal: data source and navigation depend on global visualization mode (ODS vs Agenda Urbana), using the metropolitan cohort from `GET /api/municipios/list` in AU mode.
