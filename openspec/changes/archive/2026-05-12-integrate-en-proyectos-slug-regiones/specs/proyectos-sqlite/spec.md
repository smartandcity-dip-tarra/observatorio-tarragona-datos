...
Persist agenda urban project catalogue rows from `dataset/proyectos.csv` into SQLite as a standalone `PROYECTOS` table for consumption by a future HTTP endpoint (out of scope for this change).
