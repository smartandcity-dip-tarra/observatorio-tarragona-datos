...
- [ ] 4.3 Manually verify: single-city radial matches reference structure; add one comparison → spider + legend; clear comparisons → radial; `selectedOds` filter from parent still de-emphasizes correctly on both charts.
