...
export const CREATE_METADATA_EN = `
CREATE TABLE IF NOT EXISTS METADATA_EN (
  id_indicador TEXT PRIMARY KEY NOT NULL,
  nombre TEXT,
  descripcion TEXT,
  unidad TEXT,
...
export const CREATE_DICCIONARIO_EN = `
CREATE TABLE IF NOT EXISTS DICCIONARIO_EN (
  id_dict TEXT PRIMARY KEY NOT NULL,
  nombre TEXT,
  descripcion TEXT,
  FOREIGN KEY (id_dict) REFERENCES DICCIONARIO(id_dict)
